...
The simplest way of getting started is to use the binary [installer](http://localhostr.com/hlPi05xNqlSa). Everything will be placed into `/usr/local/tranquil` (Requires Xcode 4 to be installed)
