                                 ...
                                 error:(NSError **)aoErr
{
    ...
    args.push_back(mod->getOrInsertGlobal("OBJC_CLASS_$_NSMutableDictionary", aProgram.llInt8Ty));
    args.push_back([aProgram getSelector:@"tq_dictionaryWithObjectsAndKeys:" inBlock:aBlock root:aRoot]);
    TQNode *value;
